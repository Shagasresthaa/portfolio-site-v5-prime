...
import { FaPenFancy, FaImages, FaComments, FaArrowLeft } from "react-icons/fa";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-6xl">
        <Link
          href="/admin"
          className="mb-8 inline-flex items-center gap-2 rounded-lg bg-white/10 px-4 py-2 text-white backdrop-blur-md transition hover:bg-white/20"
        >
          <FaArrowLeft />
